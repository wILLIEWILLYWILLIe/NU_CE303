...
# Generated on: Fri Oct 24 13:14:41 CDT 2025 (Fri Oct 24 18:14:41 GMT 2025)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/alu8/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/alu8 -revised fv_map
...
elaborate_design -golden -root {alu8} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/alu8/fv_map.v.gz
elaborate_design -revised -root {alu8}
