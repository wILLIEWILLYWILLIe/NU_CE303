...
# Generated on: Tue Nov 18 20:40:33 CST 2025 (Wed Nov 19 02:40:33 GMT 2025)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/mac/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/mac -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k mac.v
elaborate_design -golden -root {mac} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/mac/fv_map.v.gz
elaborate_design -revised -root {mac}
...
#add_name_alias fv/mac/fv_map.singlebit.original_name.alias.json.gz -revised
