...
# Generated on: Wed Oct 15 20:05:53 CDT 2025 (Thu Oct 16 01:05:53 GMT 2025)

set lec_version [regsub {(-)[A-Za-z]} $env(LEC_VERSION) ""]

tcl_set_command_name_echo on

set_log_file fv/alu_conv/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/alu_conv -revised fv_map
...
read_design   -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k ../alu_conv.v
elaborate_design -golden -root {alu_conv} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/alu_conv/fv_map.v.gz
elaborate_design -revised -root {alu_conv}
